...
import { currentActivities } from '../mockdata/mockActivities';

function CurrentActivitiesPage() {
...
//             // Áp dụng logic ánh xạ an toàn tương tự
...
//             return <ActivityListItem key={activityFromApi.id} activity={activityProps} />;
//           })
//         ) : (
//           <p className="text-center text-gray-500">Không có hoạt động nào đang diễn ra.</p>
//         )}
