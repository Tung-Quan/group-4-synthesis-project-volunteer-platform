...
-- =========================
-- 1) USERS: 15 volunteers + 15 organizers  (= 30 users)
-- =========================
-- password_hash: demo placeholder
INSERT INTO users (email, password_hash, full_name, phone)
VALUES
  -- Volunteers (01..15)
  ('volunteer01@example.com','hashed_pw','Volunteer 01','+840100000001'),
  ('volunteer02@example.com','hashed_pw','Volunteer 02','+840100000002'),
  ('volunteer03@example.com','hashed_pw','Volunteer 03','+840100000003'),
  ('volunteer04@example.com','hashed_pw','Volunteer 04','+840100000004'),
  ('volunteer05@example.com','hashed_pw','Volunteer 05','+840100000005'),
  ('volunteer06@example.com','hashed_pw','Volunteer 06','+840100000006'),
  ('volunteer07@example.com','hashed_pw','Volunteer 07','+840100000007'),
  ('volunteer08@example.com','hashed_pw','Volunteer 08','+840100000008'),
  ('volunteer09@example.com','hashed_pw','Volunteer 09','+840100000009'),
  ('volunteer10@example.com','hashed_pw','Volunteer 10','+840100000010'),
  ('volunteer11@example.com','hashed_pw','Volunteer 11','+840100000011'),
  ('volunteer12@example.com','hashed_pw','Volunteer 12','+840100000012'),
  ('volunteer13@example.com','hashed_pw','Volunteer 13','+840100000013'),
  ('volunteer14@example.com','hashed_pw','Volunteer 14','+840100000014'),
  ('volunteer15@example.com','hashed_pw','Volunteer 15','+840100000015'),

  -- Organizers (01..15)
  ('org01@example.com','hashed_pw','Organizer 01','+840200000001'),
  ('org02@example.com','hashed_pw','Organizer 02','+840200000002'),
  ('org03@example.com','hashed_pw','Organizer 03','+840200000003'),
  ('org04@example.com','hashed_pw','Organizer 04','+840200000004'),
  ('org05@example.com','hashed_pw','Organizer 05','+840200000005'),
  ('org06@example.com','hashed_pw','Organizer 06','+840200000006'),
  ('org07@example.com','hashed_pw','Organizer 07','+840200000007'),
  ('org08@example.com','hashed_pw','Organizer 08','+840200000008'),
  ('org09@example.com','hashed_pw','Organizer 09','+840200000009'),
  ('org10@example.com','hashed_pw','Organizer 10','+840200000010'),
  ('org11@example.com','hashed_pw','Organizer 11','+840200000011'),
  ('org12@example.com','hashed_pw','Organizer 12','+840200000012'),
  ('org13@example.com','hashed_pw','Organizer 13','+840200000013'),
  ('org14@example.com','hashed_pw','Organizer 14','+840200000014'),
  ('org15@example.com','hashed_pw','Organizer 15','+840200000015');

-- =========================
-- 2) ROLE TABLES (volunteer == students)
-- =========================
-- Volunteers -> students
...
-- SELECT COUNT(*) FROM organizers;          -- 15
-- SELECT student_no, social_work_days FROM students ORDER BY student_no;
-- SELECT * FROM student_service_ledger ORDER BY created_at DESC;
